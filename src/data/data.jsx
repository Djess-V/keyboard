...
export const btnUpP = [
  { data: [<TfiMouseAlt style={styleSVG} />], name: "mouseBtn", id: 1, code: '' },
  { data: [<TfiMusicAlt style={styleSVG} />], name: "soundBtn", id: 2, code: '' },
  { data: [<TfiHome style={styleSVG} />], name: "homeBtn", id: 3, code: '' },
  { data: [<TfiLock style={styleSVG} />, "PC"], name: "blockBtn", id: 4, code: '' },
  { data: [<TfiPowerOff style={styleSVG} />, "PC"], name: "offBtn", id: 5, code: '' },
];
...
export const btn1F = [
  ...
  { data: [<TfiPalette style={styleSVG} />, "F7"], id: 14, code: 'F7' },
  { data: [<TfiPackage style={styleSVG} />, "F8"], id: 15, code: 'F8' },
  { data: [<TfiPaintRoller style={styleSVG} />, "F9"], id: 16, code: 'F9' },
  { data: [<TfiMagnet style={styleSVG} />, "F10"], id: 17, code: 'F10' },
  { data: [<TfiLocationArrow style={styleSVG} />, "F11"], id: 18, code: 'F11' },
  { data: [<TfiMicrophone style={styleSVG} />, "F12"], id: 19, code: 'F12' },
...
export const btn3Tab = [
  { data: ["Tab", <TfiDirectionAlt style={styleSVGArrow} />], id: 36, code: 'Tab' },
...
export const btn5Space = [
  ...
  { data: ["FN"], id: 77, code: '' },
  { data: [<TfiMicrosoftAlt style={styleSVGArrow} />], id: 78, code: 'MetaLeft' },
  ...
  { data: ["AltGr"], id: 81, code: 'AltRight' },
  {
    ...
    id: 82, code: 'ControlRight'
  },
  { data: ["Home", <TfiArrowCircleLeft style={styleSVGArrow} />], id: 83, code: 'ArrowLeft' },
  {
    data: [
      "Page",
      <TfiArrowCircleDown
    ...
    id: 84, code: 'ArrowDown'
  },
  { data: ["End", <TfiArrowCircleRight style={styleSVGArrow} />], id: 85, code: 'ArrowRight' },
];
...
export const serviceButtonsId = [
  1, 2, 3, 4, 5, 21, 35, 36, 49, 62, 74, 75, 77, 76, 78, 79, 81, 82, 83, 84, 85, 86
];
